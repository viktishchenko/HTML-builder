...
[01 Чтение файла с выводом содержимого в консоль](./01-read-file)  
[02 Запись консольного ввода в файл](./02-write-file)  
[03 Вывод информации о файлаx хранящихся в папке](./03-files-in-folder)  
[04 Копирование папки](./04-copy-directory)  
[05 Сборка css бандла](./05-merge-styles)  
[06 Сборка HTML страницы из компонентов и стилей](./06-build-page)
